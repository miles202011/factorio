...
function Public.reset_table()
    ...
    this.rpg_extra.rpg_xp_yield = {
        ...
        ['spitter-spawner'] = 64,
        ['big-stomper-pentapod'] = 40,
        ['medium-stomper-pentapod'] = 25,
        ['small-stomper-pentapod'] = 15,
        ['big-strafer-pentapod'] = 30,
        ['medium-strafer-pentapod'] = 22.5,
        ['small-strafer-pentapod'] = 20,
